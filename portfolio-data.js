  ...
  experiences: [
    {
      ...
      achievements: [
        "1. 설계",
        "1-1. 구내방송장치(전관방송설비&AV설비), 영상감시장치 (CCTV), 통합배선반, 출입통제, 주차관제설비, 및 기타 통신설비",
        "1-2. 현장실측 및 도면, 내역서, 시방서 등 설계 기반 서류 작성 [관급(나라장터)/도급(산출서)/사급]",
        "1-3. 제안서 제작, 프레젠테이션 등",
        "2. Project Managing",
        "2-1. 현장 설계 협의 및 계약방법, 시공상세 등 발주처 미팅",
        "2-2. 감리단 & 감독관 서류 대응 (착/준공, 계약, 설계변경, 실정보고 등)",
        "2-3. 전문시공업체 섭외 및 기타 하도급 관련 제반 업무",
        "2-4. 공정 진행 및 인력관리 등",
        "3. 기타",
        "3-1. 공장등록 진행 (영상감시장치, 보안용 카메라)",
        "3-2. 직접생산증명 등록 (영상감시장치, 보안용 카메라)",
        "3-3. 조달청 나라장터 다수공급자물품 등록 (보안용 카메라)"
],
    ...
    },
    {
      ...
      achievements: [
        ...
        "3. 기타",
        "3-1. 해외 협력업체 업무연락 담당",
        "3-2. 인증진행 담당 (ICT 융합 품질인증, Q-Mark 인증 획득)"
],
